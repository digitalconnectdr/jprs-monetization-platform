...
export const en: Dictionary = {
  ...
  catalog: {
    ...
    dealsIntro: "Only offers with a published end date still in the future appear here. Expired offers stay in our historical records but are never shown as current.",
    noActiveDeals: "There are no current deals in this vertical right now.",
    dealEnds: "Deal ends",
    wasLabel: "Was",
  ...
  tools: {
    ...
    swipeToCompare: "Swipe sideways to see all comparison columns.",
    meshWifiFinderTitle: "Mesh Wi-Fi Finder",
    meshWifiFinderIntro: "Filter published mesh systems by the network features your home needs. Results match published specifications; they are not an editorial ranking.",
    requireWifi7: "Require Wi-Fi 7",
    requireMultiGig: "Require multi-gig Ethernet",
    requireSmartHomeHub: "Require a built-in smart-home hub",
    matchingProductsHeading: "Products matching these requirements",
    noMatchingProducts: "No products in this small catalog match every selected requirement.",
    finderMethodology: "Matches use manufacturer-published specifications. Actual coverage and speeds depend on your home, connection, devices, and placement.",
  },
};
