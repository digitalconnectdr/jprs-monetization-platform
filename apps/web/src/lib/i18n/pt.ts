...
export const pt: Dictionary = {
  ...
  search: {
    metaTitle: "Buscar",
    metaDescription: "Busque comparações e perfis de produto nos verticais da Decidero.",
    h1: "Buscar",
    submitLabel: "Buscar",
    emptyPrompt:
  ...
  catalog: {
    ...
    dealsTitle: "Ofertas atuais",
    dealsIntro: "Apenas ofertas com uma data de término publicada ainda no futuro aparecem aqui. Ofertas vencidas permanecem no nosso histórico, mas nunca são mostradas como atuais.",
    noActiveDeals: "Não há ofertas atuais neste vertical agora.",
    dealEnds: "A oferta termina",
    wasLabel: "Antes",
    saveLabel: "Economize {percent}%",
    categoryMetaDescription: "Compare opções de {category} em {niche}: preços, recursos e fontes reais, atualizados regularmente.",
    productMetaDescription: "{product} da {vendor}: preço, recursos e fontes — citadas e datadas.",
    productMetaDescriptionNoVendor: "{product}: preço, recursos e fontes — citadas e datadas.",
  ...
  tools: {
    ...
    billingModelColumn: "Faturamento",
    integrationsColumn: "Integrações",
    ...
    swipeToCompare: "Deslize horizontalmente para ver todas as colunas da comparação.",
    meshWifiFinderTitle: "Localizador de Wi-Fi mesh",
    meshWifiFinderIntro: "Filtre sistemas mesh publicados pelos recursos de rede que sua casa precisa. Os resultados correspondem às especificações publicadas; não são uma classificação editorial.",
    requireWifi7: "Exigir Wi-Fi 7",
    requireMultiGig: "Exigir Ethernet multi-gig",
    requireSmartHomeHub: "Exigir hub integrado de casa inteligente",
    matchingProductsHeading: "Produtos que correspondem a estes requisitos",
    noMatchingProducts: "Nenhum produto neste pequeno catálogo atende a todos os requisitos selecionados.",
    finderMethodology: "As correspondências usam especificações publicadas pelos fabricantes. Cobertura e velocidades reais dependem da casa, conexão, dispositivos e posicionamento.",
  },
};
