...
export const fr: Dictionary = {
  ...
  search: {
    ...
    metaDescription: "Recherchez des comparaisons et des fiches produit dans les verticales de Decidero.",
    h1: "Rechercher",
  ...
  catalog: {
    ...
    dealsTitle: "Offres en cours",
    dealsIntro: "Seules les offres avec une date de fin publiée encore à venir apparaissent ici. Les offres expirées restent dans notre historique, sans jamais être présentées comme actuelles.",
    noActiveDeals: "Il n’y a aucune offre en cours dans cette verticale pour le moment.",
    dealEnds: "L’offre se termine",
    wasLabel: "Avant",
    saveLabel: "Économisez {percent}%",
    categoryMetaDescription: "Comparez les options {category} dans {niche} : prix, caractéristiques et sources réelles, mis à jour régulièrement.",
    productMetaDescription: "{product} par {vendor} : prix, caractéristiques et sources — citées et datées.",
    productMetaDescriptionNoVendor: "{product} : prix, caractéristiques et sources — citées et datées.",
  ...
  tools: {
    ...
    requireMultiGig: "Exiger Ethernet multi-gig",
    requireSmartHomeHub: "Exiger un hub domotique intégré",
    matchingProductsHeading: "Produits correspondant à ces exigences",
    noMatchingProducts: "Aucun produit de ce petit catalogue ne correspond à toutes les exigences sélectionnées.",
    finderMethodology: "Les correspondances utilisent les spécifications publiées par les fabricants. La couverture et les vitesses réelles dépendent du domicile, de la connexion, des appareils et de l’emplacement.",
  },
};
